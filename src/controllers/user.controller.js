...
const updateAvatar = asynchandler(async (req, res) => {
 try {
  ...
  throw new ApiError(500,"problems during updating avatar")
 }
});
...
const updateCoverImage = asynchandler(async (req, res) => {
  try {
    ...
    throw new ApiError(500,"problems during updating coverImage")
  }
});
...
const getUserChannelProfile = asynchandler(async (req, res) => {
 try {
  ...
  throw new ApiError("Error during fetching channel")
 }
});
